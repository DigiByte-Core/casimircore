...
module.exports = function (settings) {
  ...
  //var isolationLevel = Sequelize.Transaction.ISOLATION_LEVELS[settings.isolationLevel]
  //if (isolationLevel) options.isolationLevel = isolationLevel
  options.isolationLevel = Sequelize.Transaction.ISOLATION_LEVELS.READ_COMMITTED;

  console.log('casimircore: options.pool = ', options.pool)
  console.log('casimircore: options.isolationLevel = ', options.isolationLevel)
